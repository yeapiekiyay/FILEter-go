...
func main() {
	...
	Usage:
	  FILEter -i <inputFile> [-o <outputFile>] [-s <startIndex>] [-l <length>] [-t <threadCount>] [--] <filter>...
	  FILEter --inputFile <inputFile> [--outputFile <outputFile>] [--outputStartIndex <startIndex>] [--outputLength <length>] [--threadCount <threadCount>] [--] <filter>...	  
	  FILEter (-h | --help)
	  FILEter (-v | --version)
	...
	Options:
	  ...
	  -t --threadCount  	Optional. The number of threads to process the file on. [default: 4]
